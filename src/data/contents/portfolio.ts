...
export const portfolios : Portfolio[] = [
    ...
    skills: ['React', 'Next' , 'TypeScript', 'SCSS', 'Vercel', 'Styled-Components','Responsive', 'Layout Design', 'Spotify API' ]
    },
    {
      id: 'portfolio-3',
      title: 'ZeroBeat App',
      ...
      state: 'preparing',
      skills: ['React Native', 'TypeScript', 'SCSS', 'Styled-Components', 'Layout Design', 'Spotify API' ]
    }
  ]